...
const createSettings = async (req, res) => {
  try {
    ...
    if (!existingSettings) {
      ...
      existingSettings.location_url = location_url || existingSettings.location_url;
      existingSettings.playstore_url = playstore_url || existingSettings.playstore_url;
      existingSettings.appstore_url = appstore_url || existingSettings.appstore_url;
      ...
      existingSettings.fcm_key = fcm_key || existingSettings.fcm_key;
      existingSettings.storage_type = storage_type || existingSettings.storage_type;
    }
...
const editSetting = async (req, res) => {
  try {
    ...
    setting.location_url = location_url !== undefined ? location_url : setting.location_url;
    setting.playstore_url = playstore_url !== undefined ? playstore_url : setting.playstore_url;
    setting.appstore_url = appstore_url !== undefined ? appstore_url : setting.appstore_url;
    ...
    setting.fcm_key = fcm_key !== undefined ? fcm_key : setting.fcm_key;
